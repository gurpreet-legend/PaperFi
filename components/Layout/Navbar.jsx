...
const Navbar = () => {
    ...
    const onThemeToggler = () => {
        toggleEl.current.checked == true ? setTheme('dark') : setTheme('light')
    }
                ...
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div className="flex ">
                        <div className="hidden relative md:block">
                            ...
                            <input type="text" id="search-navbar" className="block outline-none p-2 pl-10 w-[40vw] text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                        </div>
                    </div>
                    <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-search">
                        ...
                        <div className='flex justify-center items-center'>
                            <MoonIcon className='h-5 w-5 text-blue-700 dark:text-white ml-6 mr-2' />
