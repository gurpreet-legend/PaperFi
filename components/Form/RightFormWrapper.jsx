    ...
    return (
        <div className='flex flex-col space-y-6 p-6'>
            <div>
                ...
                <input type="text" id="title" placeholder='Bitcoin: A Peer-to-Peer Electron...' className="block outline-none p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
            <div>
            ...
            <div className='flex flex-grow'>
                <span className='text-xl text-blue-700 font-semibold grow'>Funding Amount</span>
                <input type="number" placeholder='0 ETH' className='bg-blue-400 outline-none focus:ring-1 focus:ring-blue-700 p-2 text-black placeholder:text-blue-700 rounded-md text-center' />
            </div>
            <div>
